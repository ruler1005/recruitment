...
DEGREE_TYPE = (('本科', u'本科'), ('硕士', u'硕士'), ('博士', u'博士'))
FIRST_INTERVIEW_RESULT_TYPE = (('建议复试', u'建议复试'), ('待定', u'待定'), ('放弃', u'放弃'))
# 复试面试建议
...
class Candidate(models.Model):
    ...
    paper_score = models.DecimalField(decimal_places=1, null=True, max_digits=4, blank=True, verbose_name='笔试成绩')
